        ...
        function renderMenuToHTML($currentPageId,$currentlang) {
              ...
              foreach($mymenu as $pageId => $pageParameters) {
                     if($pageId==$currentPageId){
                             echo "<button class=\"boutoncourant\"><a href=\"http://localhost/IDAW/TP2/SitePro/index.php?page=".$pageId."&lang=".$currentlang."\">".$pageParameters[0]."</a></button>";
                            
                     } else {
                            echo "<button class=\"bouton\"><a href=\"http://localhost/IDAW/TP2/SitePro/index.php?page=".$pageId."&lang=".$currentlang."\">".$pageParameters[0]."</a></button>";
                     }
